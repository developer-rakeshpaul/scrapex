...
- PII redaction (email, phone, SSN, credit card, IP) before sending to APIs
...
**Full Changelog**: https://github.com/developer-rakeshpaul/scrapex/compare/v1.0.0-alpha.1...v1.0.0-beta.1
